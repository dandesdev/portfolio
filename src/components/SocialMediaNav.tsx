...
const GitHubIcon = () => (
  <Tooltip text="GitHub">
    <SocialMediaIcon link="https://github.com/dandesdev">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="32"
        height="32"
        viewBox="0 0 24 24"
        className="fill-text hover:fill-primary hover:scale-110 transition-all origin-top opacity-90 hover:opacity-100 aspect-square object-contain"
      >
